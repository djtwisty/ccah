...
function Plugin(element, options) {
    ...
    if (window.localStorage.getItem("CountryCode") == 'it') {
        this.options = $.extend({}, defaults_it, options);
        this._defaults = defaults_it;
    }
    else if (window.localStorage.getItem("CountryCode") == 'es') {
        this.options = $.extend({}, defaults_es, options);
        this._defaults = defaults_es;
    }
        ...
        this.options = $.extend({}, defaults_fr, options);
        this._defaults = defaults_fr;
    }
    else {
        this.options = $.extend({}, defaults_us, options);
        this._defaults = defaults_us;
    }
    this.id = id++;
