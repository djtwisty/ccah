...
public final class Encoder {
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) {
        ...
        bitArray = interleaveWithECBytes(bitArray3, recommendVersion.getTotalCodewords(), totalCodewords, eCBlocksForLevel.getNumBlocks());
        ...
        dimensionForVersion = chooseMaskPattern(bitArray, errorCorrectionLevel, recommendVersion, byteMatrix);
        qRCode.setMaskPattern(dimensionForVersion);
        MatrixUtil.buildMatrix(bitArray, errorCorrectionLevel, recommendVersion, dimensionForVersion, byteMatrix);
