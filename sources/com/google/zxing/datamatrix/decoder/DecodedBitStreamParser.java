...
final class DecodedBitStreamParser {
    ...
    private static Mode decodeAsciiSegment(BitSource bitSource, StringBuilder stringBuilder, StringBuilder stringBuilder2) {
        int i = 0;
        do {
                ...
                for (readBits = 0; readBits < 3; readBits++) {
                    ...
                    switch (i) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            if (i2 < TEXT_SHIFT2_SET_CHARS.length) {
                                c = TEXT_SHIFT2_SET_CHARS[i2];
                                if (obj != null) {
                                    stringBuilder.append((char) (c + 128));
                                    obj = null;
                                } else {
    ...
    private static void decodeBase256Segment(BitSource bitSource, StringBuilder stringBuilder, Collection<byte[]> collection) {
        int available;
