...
final class State {
    ...
    State addBinaryShiftChar(int i) {
        ...
        if (this.mode == 4 || this.mode == 2) {
            ...
            token = token.add(65535 & i2, i2 >> 16);
            i3 += i2 >> 16;
            i2 = 0;
        }
        int i4 = (this.binaryShiftByteCount == 0 || this.binaryShiftByteCount == 31) ? 18 : this.binaryShiftByteCount == 62 ? 9 : 8;
        State state = new State(token, i2, this.binaryShiftByteCount + 1, i3 + i4);
