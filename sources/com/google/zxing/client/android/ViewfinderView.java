...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attributeSet) {
        ...
        this.maskColor = resources.getColor(C0306R.color.viewfinder_mask);
        this.resultColor = resources.getColor(C0306R.color.result_view);
        this.laserColor = resources.getColor(C0306R.color.viewfinder_laser);
        this.resultPointColor = resources.getColor(C0306R.color.possible_result_points);
        this.scannerAlpha = 0;
