...
public final class LocaleManager {
    ...
    private static final Collection<String> TRANSLATED_HELP_ASSET_LANGUAGES = Arrays.asList(new String[]{"de", DEFAULT_LANGUAGE, "es", "fr", "it", "ja", "ko", "nl", "pt", "ru", "uk", "zh-rCN", "zh-rTW", "zh-rHK"});
    ...
    private static String doGetTLD(Map<String, String> map, Context context) {
        String str = (String) map.get(getCountry(context));
