...
public final class Code128Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        while (i3 < length) {
            ...
            if (chooseCode == i4) {
                ...
                i2 = i4 == 0 ? chooseCode == 100 ? CODE_START_B : CODE_START_C : chooseCode;
            }
    ...
    private static int chooseCode(CharSequence charSequence, int i, int i2) {
        ...
        if (i2 != 100) {
            ...
            return findCType == CType.TWO_DIGITS ? CODE_CODE_C : 100;
            ...
            if (findCType == CType.FNC_1) {
                return findCType(charSequence, i + 3) == CType.TWO_DIGITS ? CODE_CODE_C : 100;
            } else {
                CType findCType2;
                int i3 = i + 4;
                while (true) {
                ...
                return findCType2 == CType.ONE_DIGIT ? 100 : CODE_CODE_C;
            }
        }
    }
}
