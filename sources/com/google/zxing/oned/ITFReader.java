...
public final class ITFReader extends OneDReader {
    ...
    /* renamed from: N */
    private static final int f632N = 1;
    ...
    /* renamed from: W */
    private static final int f633W = 3;
    ...
    private static void decodeMiddle(BitArray bitArray, int i, int i2, StringBuilder stringBuilder) {
        int[] iArr = new int[10];
        int[] iArr2 = new int[5];
        int[] iArr3 = new int[5];
        int i3 = i;
    ...
    private void validateQuietZone(BitArray bitArray, int i) {
        ...
        int i3 = i - 1;
        int i4 = i2;
        while (i4 > 0 && i3 >= 0 && !bitArray.get(i3)) {
            i4--;
            i3--;
        }
        if (i4 != 0) {
