        ...
        while (i8 < i) {
            ...
            if (findGuardPattern != null) {
                ...
                if (obj != null) {
                    ...
                    i8 = i5;
                    while (i8 < i) {
                        findGuardPattern2 = findGuardPattern(bitMatrix, iArr3[0], i8, i2, false, iArr, iArr2);
                        if (findGuardPattern2 == null && Math.abs(iArr3[0] - findGuardPattern2[0]) < 5 && Math.abs(iArr3[1] - findGuardPattern2[1]) < 5) {
                            i9 = 0;
                        } else if (i7 > SKIPPED_ROW_COUNT_MAX) {
                            break;
                        } else {
                            i9 = i7 + 1;
                            findGuardPattern2 = iArr3;
                        }
                        i8++;
