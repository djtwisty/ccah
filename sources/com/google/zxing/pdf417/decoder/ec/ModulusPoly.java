...
final class ModulusPoly {
    ...
    int evaluateAt(int i) {
        ...
        if (i == 1) {
            ...
            for (int add : this.coefficients) {
                int add2;
                i3 = this.field.add(i3, add2);
            }
            return i3;
        }
        i3 = this.coefficients[0];
        add2 = this.coefficients.length;
        while (i2 < add2) {
            i3 = this.field.add(this.field.multiply(i, i3), this.coefficients[i2]);
            i2++;
        }
        return i3;
    }
    ...
    ModulusPoly add(ModulusPoly modulusPoly) {
        if (!this.field.equals(modulusPoly.field)) {
            ...
            Object obj3 = modulusPoly.coefficients;
            ...
            for (int i = length; i < obj.length; i++) {
                obj5[i] = this.field.add(iArr[i - length], obj[i]);
            }
            return new ModulusPoly(this.field, obj5);
        }
    }
