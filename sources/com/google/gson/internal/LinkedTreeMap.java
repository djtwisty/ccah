...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C03691();
    ...
    static class C03691 implements Comparator<Comparable> {
        C03691() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C03701 extends LinkedTreeMapIterator<Entry<K, V>> {
            C03701() {
                super();
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C03711 extends LinkedTreeMapIterator<K> {
            C03711() {
                super();
            }
