...
public final class Gson {
    ...
    class C03501 implements JsonDeserializationContext {
        C03501() {
        }
    ...
    class C03512 implements JsonSerializationContext {
        C03512() {
        }
    ...
    class C03523 extends TypeAdapter<Number> {
        C03523() {
        }
    ...
    class C03534 extends TypeAdapter<Number> {
        C03534() {
        }
    ...
    class C03545 extends TypeAdapter<Number> {
        C03545() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingStrategy, Map<Type, InstanceCreator<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> list) {
        ...
        this.deserializationContext = new C03501();
        this.serializationContext = new C03512();
