...
final class zza {
                        ...
                        if (!TextUtils.isEmpty(zza)) {
                            ...
                            if (identifier == 0 && zzb(identifier)) {
                                ...
                                if (equals) {
                                    ...
                                    activity = zzav.zza(this.zzx, zzdn.incrementAndGet(), launchIntentForPackage, 1073741824);
                                ...
                                zzi2 = null;
                                a = new C0192c(this.zzx).m602a(true).m594a(i);
                                if (!TextUtils.isEmpty(charSequence)) {
                                    a.m600a(charSequence);
                                }
                                if (!TextUtils.isEmpty(zzd2)) {
                                    a.m605b(zzd2);
                                    a.m599a(new C0191b().m588a(zzd2));
                                }
                                if (zzl != null) {
                                    a.m608c(zzl.intValue());
                                }
                                if (uri != null) {
                                    a.m598a(uri);
                                }
                                ...
                                notificationManager = (NotificationManager) this.zzx.getSystemService("notification");
                                if (TextUtils.isEmpty(zza5)) {
                                    zza5 = "FCM-Notification:" + SystemClock.uptimeMillis();
                                }
                                notificationManager.notify(zza5, 0, a2);
                                return true;
                            }
                            ...
                            if (identifier == 0 && zzb(identifier)) {
                                ...
                                if (PlatformVersion.isAtLeastO() || this.zzx.getApplicationInfo().targetSdkVersion < 26) {
                                    ...
                                    if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                                        notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.zzx.getString(C0343R.string.fcm_fallback_notification_channel_label), 3));
                                    }
    ...
    private final Integer zzl(String str) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            if (i != 0) {
                try {
                    num = Integer.valueOf(C0100a.m123a(this.zzx, i));
