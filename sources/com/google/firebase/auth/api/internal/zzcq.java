...
final class zzcq extends zzeo<AuthResult, zza> {
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        return TaskApiCall.builder().setAutoResolveMissingFeatures(false).setFeatures(this.zznr ? null : new Feature[]{zze.zzf}).run(new zzcr(this)).build();
    }
    ...
    final /* synthetic */ void zzx(zzdq zzdq, TaskCompletionSource taskCompletionSource) {
        this.zzng = new zzew(this, taskCompletionSource);
        if (this.zznr) {
            zzdq.zzdh().zzb(this.zzls.getToken(), this.zznc);
        } else {
            zzdq.zzdh().zza(this.zzls, this.zznc);
        }
    }
}
