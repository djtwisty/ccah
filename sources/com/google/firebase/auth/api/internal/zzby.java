...
@VisibleForTesting
final class zzby extends zzeo<AuthResult, zza> {
    ...
    public final TaskApiCall<zzdq, AuthResult> zzdb() {
        return TaskApiCall.builder().setAutoResolveMissingFeatures(false).setFeatures(this.zznr ? null : new Feature[]{zze.zzf}).run(new zzbz(this)).build();
    }
    ...
    final /* synthetic */ void zzp(zzdq zzdq, TaskCompletionSource taskCompletionSource) {
