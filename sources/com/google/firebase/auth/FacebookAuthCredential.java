...
public class FacebookAuthCredential extends AuthCredential {
    ...
    @Constructor
    FacebookAuthCredential(@Param(id = 1) String str) {
    ...
    public static zzdr zza(FacebookAuthCredential facebookAuthCredential, String str) {
        ...
        return new zzdr(null, facebookAuthCredential.zzgd, facebookAuthCredential.getProvider(), null, null, null, str, null);
    }
