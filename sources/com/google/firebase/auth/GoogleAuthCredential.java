...
public class GoogleAuthCredential extends AuthCredential {
    ...
    @Constructor
    GoogleAuthCredential(@Param(id = 1) String str, @Param(id = 2) String str2) {
    ...
    public static zzdr zza(GoogleAuthCredential googleAuthCredential, String str) {
        ...
        return new zzdr(googleAuthCredential.zzgc, googleAuthCredential.zzgd, googleAuthCredential.getProvider(), null, null, null, str, null);
    }
