...
public final class zzbi {
    ...
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) {
        ...
        if (obj instanceof zzbh) {
            ...
            if (str != null) {
                stringBuffer2.append(stringBuffer).append(zze(str)).append(" <\n");
                stringBuffer.append("  ");
            }
        ...
        if (obj instanceof String) {
            obj = (String) obj;
            if (!obj.startsWith(HttpHost.DEFAULT_SCHEME_NAME) && obj.length() > HttpStatus.SC_OK) {
                obj = String.valueOf(obj.substring(0, HttpStatus.SC_OK)).concat("[...]");
            }
