...
final class zzhf {
    static String zza(zzhc zzhc, String str) {
        ...
        zza(zzhc, stringBuilder, 0);
        return stringBuilder.toString();
    }

    private static void zza(zzhc zzhc, StringBuilder stringBuilder, int i) {
        Map hashMap = new HashMap();
        Map hashMap2 = new HashMap();
        Set<String> treeSet = new TreeSet();
        for (Method method : zzhc.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (!(!replaceFirst.endsWith("List") || replaceFirst.endsWith("OrBuilderList") || replaceFirst.equals("List"))) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(stringBuilder, i, zzdd(valueOf), zzft.zza(method2, (Object) zzhc, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf2.length() != 0 ? str2.concat(valueOf2) : new String(str2))) != null) {
                ...
                if (method2 != null) {
                    ...
                    if (method3 == null) {
                        ...
                        equals = ((Boolean) zzft.zza(method3, (Object) zzhc, new Object[0])).booleanValue();
                    }
                    if (equals) {
                        zza(stringBuilder, i, zzdd(concat), zza);
                    }
                }
            }
        }
        if (zzhc instanceof zzc) {
            Iterator it = ((zzc) zzhc).zzxe.iterator();
            if (it.hasNext()) {
                ((Entry) it.next()).getKey();
                throw new NoSuchMethodError();
            }
        }
        if (((zzft) zzhc).zzwy != null) {
            ((zzft) zzhc).zzwy.zza(stringBuilder, i);
        }
    }
    ...
    static final void zza(StringBuilder stringBuilder, int i, String str, Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                stringBuilder.append(": \"").append(zzik.zzf(zzeh.zzcz((String) obj))).append('\"');
            } else if (obj instanceof zzeh) {
                stringBuilder.append(": \"").append(zzik.zzf((zzeh) obj)).append('\"');
            } else if (obj instanceof zzft) {
                stringBuilder.append(" {");
                zza((zzft) obj, stringBuilder, i + 2);
                stringBuilder.append("\n");
                while (i2 < i) {
                    stringBuilder.append(' ');
                    i2++;
