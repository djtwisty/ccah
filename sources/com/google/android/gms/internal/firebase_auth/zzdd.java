...
public final class zzdd extends AbstractSafeParcelable {
    ...
    @Constructor
    zzdd(@Param(id = 2) List<zzdb> list) {
    ...
    public static zzdd zza(zzdd zzdd) {
        Collection collection = zzdd.zzpm;
        zzdd zzdd2 = new zzdd();
        if (collection != null) {
            zzdd2.zzpm.addAll(collection);
        }
        return zzdd2;
    }
    ...
    public static zzdd zzc(List<zzm> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            arrayList.add(new zzdb(Strings.emptyToNull(zzm.zzbg()), Strings.emptyToNull(zzm.getDisplayName()), Strings.emptyToNull(zzm.zzal()), Strings.emptyToNull(zzm.getProviderId()), null, Strings.emptyToNull(zzm.getPhoneNumber()), Strings.emptyToNull(zzm.getEmail())));
        }
