...
public class GoogleSignatureVerifier {
    ...
    private final zzm zza(String str, int i) {
        try {
            ...
            if (!zza2.zzad || zza.applicationInfo == null || (zza.applicationInfo.flags & 2) == 0) {
                return zza2;
            }
            if (!honorsDebugCertificates || zzc.zza(str2, zzf, false, false).zzad) {
    ...
    private final zzm zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                if (zzb.zzad && packageInfo.applicationInfo != null && (packageInfo.applicationInfo.flags & 2) != 0 && (!honorsDebugCertificates || zzc.zza(str2, zzf, false, false).zzad)) {
