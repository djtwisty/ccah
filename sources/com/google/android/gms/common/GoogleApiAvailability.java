...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Task<Void> makeGooglePlayServicesAvailable(Activity activity) {
        ...
        com.google.android.gms.common.api.internal.zal zac = zabu.zac(activity);
    ...
    static void zaa(Activity activity, Dialog dialog, String str, OnCancelListener onCancelListener) {
        if (activity instanceof C0145j) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((C0145j) activity).getSupportFragmentManager(), str);
            return;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        if (i == 18) {
            ...
            C0192c a = new C0192c(context).m606b(true).m602a(true).m600a(errorNotificationTitle).m599a(new C0191b().m588a(errorNotificationMessage));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                a.m594a(context.getApplicationInfo().icon).m603b(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    a.m595a(C0319R.drawable.common_full_open_on_phone, resources.getString(C0319R.string.common_open_on_phone), pendingIntent);
                } else {
                    a.m597a(pendingIntent);
                }
            } else {
                a.m594a(17301642).m609c(resources.getString(C0319R.string.common_google_play_services_notification_ticker)).m596a(System.currentTimeMillis()).m597a(pendingIntent).m605b(errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
