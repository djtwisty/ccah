...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, C0131i c0131i, int i2, OnCancelListener onCancelListener) {
        if (GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(activity, i)) {
            i = 18;
        }
        ...
        Dialog zaa = GoogleApiAvailability.zaa((Context) activity, i, DialogRedirect.getInstance(c0131i, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, "d"), i2), onCancelListener);
        if (zaa == null) {
            return false;
        }
