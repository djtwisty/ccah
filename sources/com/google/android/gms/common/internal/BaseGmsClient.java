            ...
            switch (i) {
                ...
                case 3:
                    ...
                    if (!(this.zzci == null || this.zzbz == null)) {
                        ...
                        Log.e("GmsClient", new StringBuilder((String.valueOf(zzu).length() + 70) + String.valueOf(packageName).length()).append("Calling connect() while still connected, missing disconnect() for ").append(zzu).append(" on ").append(packageName).toString());
                        this.zzcb.zza(this.zzbz.zzu(), this.zzbz.getPackageName(), this.zzbz.zzq(), this.zzci, zzj());
                    ...
                    if (!this.zzcb.zza(new zza(this.zzbz.zzu(), this.zzbz.getPackageName(), this.zzbz.zzq()), this.zzci, zzj())) {
                        zzu = this.zzbz.zzu();
                        packageName = this.zzbz.getPackageName();
                        Log.e("GmsClient", new StringBuilder((String.valueOf(zzu).length() + 34) + String.valueOf(packageName).length()).append("unable to connect to service: ").append(zzu).append(" on ").append(packageName).toString());
