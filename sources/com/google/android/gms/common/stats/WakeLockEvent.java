...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzw() {
        ...
        return new StringBuilder(((((String.valueOf(str5).length() + 45) + String.valueOf(str).length()) + String.valueOf(str2).length()) + String.valueOf(str3).length()) + String.valueOf(str4).length()).append("\t").append(str5).append("\t").append(i).append("\t").append(str).append("\t").append(i2).append("\t").append(str2).append("\t").append(str3).append("\t").append(f).append("\t").append(str4).toString();
    }
}
