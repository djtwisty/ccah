...
public class zzcu {
    ...
    public static final String[] zzaqr = new String[]{"_cd", Event.APP_EXCEPTION, "_ui", "_ug", "_in", "_au", "_cmp", "_cmp", "_err", "_f", "_v", "_iap", "_nd", "_nf", "_no", "_nr", "_ou", "_s", "_e", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", Event.AD_REWARD, "_vs", "_ep"};
