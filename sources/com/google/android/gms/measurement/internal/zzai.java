...
public final class zzai {
    ...
    public static zza<Integer> zzajh = zza.zzc("measurement.upload.max_conversions_per_day", HttpStatus.SC_INTERNAL_SERVER_ERROR, HttpStatus.SC_INTERNAL_SERVER_ERROR);
    ...
    public static zza<Integer> zzajz = zza.zzc("measurement.audience.filter_result_max_count", HttpStatus.SC_OK, HttpStatus.SC_OK);
        ...
        private static void zzq() {
            synchronized (zza.class) {
                ...
                for (zza zza2 : zzai.zzail) {
                    ...
                    str = zza2.zzoj;
                    zzn = zzai.zzaih;
                    zza2.zzalh = zziz.zzy(str, (String) zza2.zzaan);
                }
                for (zza zza22 : zzai.zzaij) {
                    zziz = zzai.zzain;
                    str = zza22.zzoj;
                    zzn = zzai.zzaih;
                    zza22.zzalh = zziz.zze(str, ((Long) zza22.zzaan).longValue());
                }
                for (zza zza222 : zzai.zzaii) {
                    zziz = zzai.zzain;
                    str = zza222.zzoj;
                    zzn = zzai.zzaih;
                    zza222.zzalh = zziz.zzd(str, ((Integer) zza222.zzaan).intValue());
                }
                for (zza zza2222 : zzai.zzaim) {
                    zziz = zzai.zzain;
                    str = zza2222.zzoj;
                    zzn = zzai.zzaih;
                    zza2222.zzalh = zziz.zzb(str, ((Double) zza2222.zzaan).doubleValue());
                }
            }
        }
        ...
        private static void zzja() {
            synchronized (zza.class) {
                ...
                try {
                    ...
                    for (zza zza22 : zzai.zzaij) {
                        zza22.zzalj = zza22.zzalh.get();
                    }
                    for (zza zza222 : zzai.zzaii) {
                        zza222.zzalj = zza222.zzalh.get();
                    }
                    for (zza zza2222 : zzai.zzaim) {
                        zza2222.zzalj = zza2222.zzalh.get();
                    }
                } catch (Exception e) {
                    zzai.zza(e);
                }
    ...
    static void zza(Exception exception) {
        if (zzada != null) {
            ...
            if (zzaio == null) {
                zzaio = Boolean.valueOf(GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(context, 12451000) == 0);
            }
            if (zzaio.booleanValue()) {
                zzada.zzgt().zzjg().zzg("Got Exception on PhenotypeFlag.get on Play device", exception);
            }
        }
    }
    ...
    static {
        ...
        zzaiz = zza.zzd("measurement.config.url_authority", str, str);
        str = "https://app-measurement.com/a";
        zzajk = zza.zzd("measurement.upload.url", str, str);
        str = "---";
        zzakc = zza.zzd("measurement.test.string_flag", str, str);
    }
}
