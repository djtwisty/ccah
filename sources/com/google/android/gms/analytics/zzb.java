...
public final class zzb extends zzat implements zzo {
    ...
    private static Map<String, String> zzc(zzg zzg) {
        ...
        if (zzab != null) {
            for (Entry entry : zzab.zzaw().entrySet()) {
                ...
                if (value == null) {
                    ...
                    obj = d.doubleValue() != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? zza(d.doubleValue()) : null;
                } else {
        ...
        if (zzy != null) {
            ...
            zza(hashMap, Param.ACLID, zzy.zzat());
        }
        ...
        if (zzz != null) {
            for (Entry entry2 : zzz.zzau().entrySet()) {
                zze = zzd.zze(((Integer) entry2.getKey()).intValue());
        ...
        if (zzaa != null) {
            for (Entry entry22 : zzaa.zzav().entrySet()) {
                zze = zzd.zzg(((Integer) entry22.getKey()).intValue());
                if (!TextUtils.isEmpty(zze)) {
                    hashMap.put(zze, zza(((Double) entry22.getValue()).doubleValue()));
                }
            }
        }
        ...
        if (zzad != null) {
            ...
            i = 1;
            for (Entry entry222 : zzad.zzaz().entrySet()) {
                List<Product> list = (List) entry222.getValue();
                String zzn3 = zzd.zzn(i);
                int i2 = 1;
                for (Product zzn22 : list) {
                    String valueOf = String.valueOf(zzn3);
                    String valueOf2 = String.valueOf(zzd.zzl(i2));
                    hashMap.putAll(zzn22.zzn(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf)));
                    i2++;
                }
