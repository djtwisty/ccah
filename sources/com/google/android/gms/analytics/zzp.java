...
final class zzp implements Runnable {
    ...
    public final void run() {
        ...
        boolean z2 = this.zztg.equals("transaction") || this.zztg.equals("item");
        if (z2 || this.zztl.zzta.zzew()) {
            ...
            String str3 = this.zztk;
            if (TextUtils.isEmpty((CharSequence) this.zzte.get("adid"))) {
                z = false;
            }
            this.zzte.put("_s", String.valueOf(this.zztl.zzcc().zza(new zzaz(0, str2, str3, z, 0, hashMap))));
