...
public class ProviderInstaller {
    ...
    public static void installIfNeeded(Context context) {
        ...
        synchronized (lock) {
            try {
                if (zziv == null) {
                    zziv = zzk.getClassLoader().loadClass("com.google.android.gms.common.security.ProviderInstallerImpl").getMethod("insertProvider", new Class[]{Context.class});
                }
                zziv.invoke(null, new Object[]{zzk});
            } catch (Exception e2) {
                e = e2;
                cause = e.getCause();
