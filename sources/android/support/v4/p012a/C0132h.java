...
public class C0132h extends C0131i implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0149n c0149n, String str) {
        ...
        C0122s a = c0149n.mo98a();
        a.mo56a(this, str);
        a.mo58b();
    }

    public int show(C0122s c0122s, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0122s.mo56a(this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0122s.mo58b();
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo99a(this.mBackStackId, 1);
                this.mBackStackId = -1;
                return;
            }
            C0122s a = getFragmentManager().mo98a();
            a.mo55a(this);
            if (z) {
                a.mo59c();
            } else {
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m282i().getSystemService("layout_inflater");
        }
